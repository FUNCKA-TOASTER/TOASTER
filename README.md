...
__Подробнее в WIKI ["Главная страница"](https://github.com/Oidaho)__
...
<!--
Предупреждения имеют свой срок давности, из-за чего через некоторое время пользователь снова очистит свою репутацию, кол-во предупреждений спадет до нуля.
